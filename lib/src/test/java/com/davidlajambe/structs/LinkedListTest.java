...
public class LinkedListTest {
    ...
    @Test public void append() {
        LinkedList<Integer> list = new LinkedList<Integer>();
        assertTrue("List length should be 0 after initialization", list.size() == 0);

        Integer node_1_val = 10;
        list.append(node_1_val);
        assertTrue("List length should be 1 after adding 1 node", list.size() == 1);
        assertTrue(
        ...
        assertTrue("List length should be 2 after adding 2 nodes", list.size() == 2);
        assertTrue(
